...
const Magicquatturo2 = () => {
    ...
    return(
       <>
        <Container>
                <Img src={img}/>
                <MainTitle>숫자로 보는 Magicquattuor2</MainTitle>
                <Wrapper>
                    <ContentWrapper>
                        <ContentTitle>23.5kg</ContentTitle>
                        <Content>Magicquattuor2는 무게가 23.5kg에 불과하여, 도시를 돌아다니는 데 완벽한 동반자가 됩니다.</Content>
                    </ContentWrapper>
                    <ContentWrapper>
                        <ContentTitle>145 ~ 185cm</ContentTitle>
                        <Content>접근성을 염두에 두고 설게된 Magicquattuor2는 다양한 키, 몸집, 숙련도의 라이더들에게 적합합니다.</Content>
                    </ContentWrapper>
                    <ContentWrapper>
                    ...
                    <ContentWrapper>
                        ...
                        <Content>최대 지원 속도가 시간당 25km인 Magicquattuor2는 스트레스 없이 라이딩을 즐길 수 있도록 해줍니다.</Content>
                    </ContentWrapper>
                    <ContentWrapper>
                        <ContentTitle>110km</ContentTitle>
                        <Content>곳곳에 데려다 줄 수 있는 Magicquattuor2는 한 번 충전에 110km까지 도달 가능합니다.</Content>
                    </ContentWrapper>
                    <ContentWrapper>
                        <ContentTitle>2.5시간</ContentTitle>
                        <Content>단 2.5시간을 들이면 Magicquattuor2가 0에서 100으로 충전되어, 이동에 문제 없습니다!.</Content>
                    </ContentWrapper>
                </Wrapper>
                ...
                {show[3] ? 
                    <SubContentContainer>
                        ...
                        <SubContentWrapper><SubContentName>Magicquattuor2Secure</SubContentName><SubContent>있음</SubContent></SubContentWrapper>
                        <SubContentWrapper><SubContentName>라이딩 대시보드 및 내비게이션</SubContentName><SubContent>있음</SubContent></SubContentWrapper>
                        <SubContentWrapper><SubContentName>Magicquattuor2Ride</SubContentName><SubContent>있음</SubContent></SubContentWrapper>
